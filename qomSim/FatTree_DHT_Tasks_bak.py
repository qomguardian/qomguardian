...
if __name__ == "__main__":
    ...
    # logging.info("The true segment flows")
    # for j in range(len(MonitorData.segmentTopKFlows)):
    #     # the j-th segment, the i-th sketch result
    #     logging.info(f"### Segment {j} ###")
    ...
    #                             reverse=True)
    #     segment_pkt_num = 0
    #     for fl in sorted_true:
    #         segment_pkt_num += fl[1]     
    #     logging.info(f"There are {len(sorted_true)} flows in this segment")
    #     logging.info(f"There are {segment_pkt_num} packets in this segment")
